...
if benchmark == 2:
    network_dataPINN = load_model('trained_networks/SWE_maxiter10000_b2_dataAndPhysics_2.h5')
...
if plot == 1:
    ...
    plt.legend()
    if save:
        plt.savefig('plots/final_plots/h_evolution_plot_b'+str(ModelInfo.benchmark)+'.png')
    plt.show()
    ...
    plt.legend()
    if save:
        plt.savefig('plots/final_plots/uh_evolution_plot_b'+str(ModelInfo.benchmark)+'.png')
    plt.show()
...
if plot == 2:
    ...
    if save:
        plt.savefig('plots/final_plots/h_b'+ str(ModelInfo.benchmark)+'.png')
    plt.show()
    ...
    if save:
        plt.savefig('plots/final_plots/uh_b'+ str(ModelInfo.benchmark)+'.png')
    plt.show()
...
if plot == 3:
    ...
    def heat_map_plot(sol_array, title_array, t, x, titlefile, label_plot, ymin = -1, ymax = 1, save = True):
        ...
        plt.tight_layout()
        if save:
            plt.savefig('plots/final_plots/'+ titlefile + '.png')
        plt.show()
